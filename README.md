...
- --image-model, -i Image model (e.g., gemini-3.1-flash-image)
...
- --video-model, -v Video model (e.g., veo-3.1-fast-generate-preview)
...
npx fauxmium gemini -m gemini-3.8-flash -i gemini-3.1-flash-image -v veo-3.1-fast-generate-preview

# Use top-level image command for image-specific configuration
npx fauxmium images gemini --image-model gemini-3.1-flash-image

# Use top-level video command for video-specific configuration
npx fauxmium video gemini --video-model veo-3.1-generate-001

# Use nested subcommands for configuration
npx fauxmium anthropic images --image-provider gemini --image-model gemini-3.1-flash-image
npx fauxmium anthropic videos --video-provider gemini --video-model veo-3.1-fast-generate-preview
```
